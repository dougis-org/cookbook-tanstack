  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white">{user.name || "No name set"}</h3>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Member since {new Date(user.createdAt).toISOString().split("T")[0]}</p>
        </div>
      </div>
