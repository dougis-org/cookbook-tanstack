# multiselect-selected-first Specification

## Purpose
Defines the sort-order behaviour for `MultiSelectDropdown`: selected (checked) options always appear before unselected options, with each group sorted alphabetically by name.
