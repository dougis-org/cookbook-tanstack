# taxonomy-multiselect-edit Specification

## Purpose
Replaces plain text inputs for Meals, Courses, and Preparations in the recipe edit/create form with `MultiSelectDropdown` components, enabling structured taxonomy selection.
