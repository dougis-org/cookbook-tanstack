...
Enable infinite scrolling of recipes in the Add Recipe modal with server-side search (name + ingredients), replacing the previous single-page client-side query.
