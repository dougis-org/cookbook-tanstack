# source-picker-dropdown Specification

## Purpose
A filterable single-select dropdown component (`SourcePickerDropdown`) for selecting an existing source on the recipe edit form, with search filtering and a clear affordance.
