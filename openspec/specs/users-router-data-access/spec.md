This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-08-21-fix-users-router-db-singleton/design.md) document, not a replacement.
