...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-07-16-fix-build-status-comment-dedup/design.md) document, not a replacement.
...
- Requirement -> Task(s): see [`tasks.md`](../../changes/archive/2026-07-16-fix-build-status-comment-dedup/tasks.md) for the implementation breakdown of the `notify-status` job
