...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-07-16-print-personal-recipe-notes/design.md) document, not a replacement.
