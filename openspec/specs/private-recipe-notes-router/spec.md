...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-06-27-private-recipe-notes-router/design.md) document, not a replacement.
