...
Two-column print layout for the Cookbook Table of Contents page (`/cookbooks/$cookbookId/toc`). The TOC prints in 2 columns to make better use of the page and reduce the number of printed pages. Screen layout is unchanged.
