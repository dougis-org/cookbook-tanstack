...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-06-28-admin-audit-log-viewer/design.md) document, not a replacement.
