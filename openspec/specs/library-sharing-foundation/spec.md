...
This document details *changes* to requirements and is additive to the [`design.md`](../../changes/archive/2026-09-25-share-my-library-foundation/design.md) document, not a replacement.
