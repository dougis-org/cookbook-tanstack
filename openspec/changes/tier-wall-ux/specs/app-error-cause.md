...
### Requirement: ADDED AppErrorCause type and tRPC errorFormatter
...
### Requirement: MODIFIED Tier enforcement error code
...
No requirements removed. Ownership `FORBIDDEN` behavior is unchanged.

## Traceability

- Proposal element "Switch tier errors from FORBIDDEN to PAYMENT_REQUIRED" -> Requirement: MODIFIED Tier enforcement error code
- Design Decision 1 (AppErrorCause + errorFormatter) -> Requirement: ADDED AppErrorCause type and errorFormatter
- Requirement: ADDED AppErrorCause -> Task: implement-error-formatter
