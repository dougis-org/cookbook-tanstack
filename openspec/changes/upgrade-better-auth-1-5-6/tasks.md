...
- [ ] Commit all changes (`package.json`, `package-lock.json`) to the working branch and push to remote
- [ ] Open PR from `upgrade-better-auth-1-5-6` to `main` referencing issue #257
