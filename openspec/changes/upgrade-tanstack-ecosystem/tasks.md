...
- [ ] 3.4 Smoke-test unsaved-changes guard: open recipe edit form, make a change, attempt to navigate away — blocker dialog must appear
...
- [ ] 4.6 Enable auto-merge once all checks are green and no blocking comments remain

## 5. Post-Merge

- [ ] 5.1 Checkout `main` and pull: `git checkout main && git pull --ff-only`
- [ ] 5.2 Verify merged changes appear on `main`
- [ ] 5.3 Sync approved spec deltas to `openspec/specs/` (no spec changes in this upgrade — confirm no action needed)
