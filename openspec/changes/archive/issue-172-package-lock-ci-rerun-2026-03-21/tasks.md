...
- [x] 5.3 After merge, run `openspec archive change issue-172-package-lock-ci-rerun`.

## 6. Post-Merge Cleanup

- [x] 6.1 Delete feature branch.
- [x] 6.2 Confirm issue #172 is closed automatically or manually.
