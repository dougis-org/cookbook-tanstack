...
- **Given** a cookbook print page (`/cookbooks/:id/print`) with recipes that have meal, course, preparation, and category badges
...
**Reason for removal:** The wrapper div is now hidden in print, making these rules dead code. Removing them prevents confusion about intent and keeps the stylesheet clean.
