...
- [x] 4.4 Resolve any CI failures or review comments before merge

## 5. Post-Merge

- [x] 5.1 Archive this change: `/opsx:archive`
- [x] 5.2 Sync approved spec to `openspec/specs/cookbook-auth-gating/spec.md`
- [x] 5.3 Delete local feature branch after merge
