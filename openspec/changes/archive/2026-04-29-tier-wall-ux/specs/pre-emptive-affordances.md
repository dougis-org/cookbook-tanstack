...
### Requirement: ADDED Disabled create buttons at tier limit
...
### Requirement: ADDED Private toggle hidden for ineligible tiers
...
### Requirement: ADDED Import entry point hidden for ineligible tiers
...
- Proposal element "Pre-emptive affordances on create buttons" -> Requirement: ADDED Disabled create buttons at tier limit
- Proposal element "Hide private toggle for lower tiers" -> Requirement: ADDED Private toggle hidden for ineligible tiers
- Proposal element "Hide/disable import entry point" -> Requirement: ADDED Import entry point hidden for ineligible tiers
- Design Decisions 2 + 3 -> All three requirements above
- Requirements -> Task: implement-pre-emptive-affordances
