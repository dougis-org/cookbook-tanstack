...
- [x] 11.1 Archive this change: run `/opsx:archive embed-marked-status`
- [x] 11.2 Sync the approved spec to `openspec/specs/recipe-marked-status/spec.md`
- [x] 11.3 Delete the local feature branch after merge: `git branch -d feat/embed-marked-status`
