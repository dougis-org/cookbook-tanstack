...
- [ ] 8.3 Smoke-test locally: start dev server, verify heart icon appears on recipe list cards for a logged-in user, and verify Save/Saved button on detail page still works correctly
...
- [ ] 10.1 Archive this change: run `/opsx:archive recipe-marked-ui`
- [ ] 10.2 Sync the approved spec deltas to `openspec/specs/`
- [ ] 10.3 Delete the local feature branch after merge: `git branch -d feat/recipe-marked-ui`
