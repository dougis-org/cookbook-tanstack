...
- Requirement -> Task(s): see `tasks.md` (implementation task updating `RecipeDetail.tsx` instruction markup; verification task covering print preview and existing tests)
