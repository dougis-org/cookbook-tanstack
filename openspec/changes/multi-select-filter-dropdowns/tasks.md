...
- [ ] 8.1 Commit all changes with a descriptive message referencing issue #165
- [ ] 8.2 Push branch and open PR against `main`; reference issue #165 in PR description
- [ ] 8.3 Enable auto-merge on the PR
- [ ] 8.4 Resolve any CI failures or review comments before merge (do not skip hooks or bypass checks)
